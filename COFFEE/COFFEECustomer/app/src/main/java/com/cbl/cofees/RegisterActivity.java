...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendingUser.addProperty("type", "CUSTOMER");
    ...
    public void eventExecution(Object event) {
        if (event instanceof EventRegisterUser) {
            startActivity(new Intent(RegisterActivity.this, ShopLocationActivity.class).putExtra("user_id",((EventRegisterUser) event).getUser_id()));
            finish();
        }
    }
